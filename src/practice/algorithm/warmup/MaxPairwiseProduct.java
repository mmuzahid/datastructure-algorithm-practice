...
public class MaxPairwiseProduct {
    static int getMaxPairwiseProductBruteForce(int[] numbers) {
        int max_product = 0;
    ...
    public static void main(String[] args) {
    	/* Stress Test
    	 while(true) {
        	...
        	if (getMaxPairwiseProduct(test_numbers) != getMaxPairwiseProductBruteForce(test_numbers))  {
        		
        		System.out.println("MISMATCH");

        		System.out.println(Arrays.toString(test_numbers));
        		long s1 = getMaxPairwiseProduct(test_numbers);
        		long s2 = getMaxPairwiseProductBruteForce(test_numbers);
